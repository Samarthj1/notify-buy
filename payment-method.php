...
if(strlen($_SESSION['login'])==0) {   
    ...
    if (isset($_POST['submit'])) {
        ...
        // Get total amount from session (set this in cart page)
        $amount = isset($_SESSION['tp']) ? $_SESSION['tp'] : '0.00';
        
        // Clear the cart
        unset($_SESSION['cart']);

        // WhatsApp message
        $msg = urlencode("Your order of Rs. $amount has been successfully placed. Thank you for shopping with us!");

        // Redirect to WhatsApp with message
        echo "<script>
                alert('Your order is placed successfully!');
                window.location.href='https://wa.me/9964190076?text=$msg';
              </script>";
        exit();
    }
?>
